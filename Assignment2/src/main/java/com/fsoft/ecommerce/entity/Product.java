...
@Table(name = "products", indexes = {
    ...
    // Thêm indexes tối ưu cho price range và search performance
    @Index(name = "idx_product_price", columnList = "price"),
    @Index(name = "idx_product_price_stock", columnList = "price, stockQuantity"),
    @Index(name = "idx_product_category_price", columnList = "category, price"),
    @Index(name = "idx_product_rating_name", columnList = "average_rating, name"),
    // Composite index tối ưu cho advanced search
    @Index(name = "idx_product_search_optimized", columnList = "category, price, stockQuantity, name")
})
// Thêm full-text index cho MySQL (sẽ được tạo qua SQL migration)
